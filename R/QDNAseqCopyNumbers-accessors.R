...
setMethod('initialize', 'QDNAseqCopyNumbers', function(.Object, bins,
  copynumber, phenodata, ...) {
...
setReplaceMethod('copynumber', signature=c(object='QDNAseqCopyNumbers',
...
setReplaceMethod('segmented', signature=c(object='QDNAseqCopyNumbers',
  value='matrix'), definition=function(object, value) {
  if (nrow(value) == nrow(object)) {
...
setReplaceMethod('calls', signature=c(object='QDNAseqCopyNumbers',
  value='matrix'), definition=function(object, value) {
  if (nrow(value) == nrow(object)) {
...
setReplaceMethod('probdloss', signature=c(object='QDNAseqCopyNumbers',
  value='matrix'), definition=function(object, value) {
  if (nrow(value) == nrow(object)) {
...
setReplaceMethod('probloss', signature=c(object='QDNAseqCopyNumbers',
  value='matrix'), definition=function(object, value) {
  if (nrow(value) == nrow(object)) {
...
setReplaceMethod('probnorm', signature=c(object='QDNAseqCopyNumbers',
  value='matrix'), definition=function(object, value) {
  if (nrow(value) == nrow(object)) {
...
setReplaceMethod('probgain', signature=c(object='QDNAseqCopyNumbers',
  value='matrix'), definition=function(object, value) {
  if (nrow(value) == nrow(object)) {
...
setReplaceMethod('probamp', signature=c(object='QDNAseqCopyNumbers',
  value='matrix'), definition=function(object, value) {
  if (nrow(value) == nrow(object)) {
