...
setMethod("plot", signature(x="QDNAseqSignals", y="missing"),
    ...
    delcol=getOption("QDNAseq::delcol", "#F2D200"),
    losscol=getOption("QDNAseq::losscol", "#318CE7"),
    gaincol=getOption("QDNAseq::gaincol", "#FF523F"),
    ampcol=getOption("QDNAseq::ampcol", "#D40000"),
    pointcol=getOption("QDNAseq::pointcol", "gray"),
    segcol=getOption("QDNAseq::segcol", "#002458"),
